...
class Str {
    ...
    static padLeft(value, length, pad = ' ') {
        var _b;
        const short = Math.max(0, length - ((_b = value.length) !== null && _b !== void 0 ? _b : 0));
...
class Carbon {
    ...
    format(format) {
        ...
        const options = {
            ...
            second: 'numeric',
            hour12: undefined,
            timeZone: (_b = __classPrivateFieldGet(this, _Carbon_timezone, "f")) !== null && _b !== void 0 ? _b : undefined,
        };
        ...
        let days = [];
        let months = [];
        const now = new Date(__classPrivateFieldGet(this, _Carbon_date, "f").toLocaleString('en-US', options));
        ...
        for (const element of elements) {
            switch (element) {
                ...
                case 'v': {
                    date += Str.padLeft(__classPrivateFieldGet(this, _Carbon_date, "f").getMilliseconds().toString(), 3, '0');
                    break;
                }
                ...
                case 'Z': {
                    const timeZoneData = now.toLocaleDateString('en-us', { timeZoneName: 'short', timeZone: (_j = __classPrivateFieldGet(this, _Carbon_timezone, "f")) !== null && _j !== void 0 ? _j : undefined, })
                        .split(', ')
                        .pop()
                        .trim();
     ...
     */
    isLocal() {
        return this.format('Z') / 60 === __classPrivateFieldGet(this, _Carbon_date, "f").getTimezoneOffset() * -1;
    }
    /**
     ...
     */
    isNextYear() {
        return parseInt(this.format('Y')) === parseInt(_a.now().format('Y')) + 1;
    }
    /**
    ...
    toObject() {
        return {
            year: __classPrivateFieldGet(this, _Carbon_date, "f").getFullYear(),
            month: __classPrivateFieldGet(this, _Carbon_date, "f").getMonth() + 1,
            day: __classPrivateFieldGet(this, _Carbon_date, "f").getDate(),
            dayOfWeek: parseInt(this.format('N')),
            dayOfYear: parseInt(this.format('z')),
            hour: __classPrivateFieldGet(this, _Carbon_date, "f").getHours(),
            minute: __classPrivateFieldGet(this, _Carbon_date, "f").getMinutes(),
            second: __classPrivateFieldGet(this, _Carbon_date, "f").getSeconds(),
            micro: undefined,
            timestamp: __classPrivateFieldGet(this, _Carbon_date, "f").valueOf(),
