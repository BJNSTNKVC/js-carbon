...
var _Carbon_instances, _a, _Carbon_date, _Carbon_timezone, _Carbon_ATOM, _Carbon_COOKIE, _Carbon_ISO8601, _Carbon_ISO8601_EXPANDED, _Carbon_RFC822, _Carbon_RFC850, _Carbon_RFC1036, _Carbon_RFC1123, _Carbon_RFC2822, _Carbon_RFC3339, _Carbon_RFC3339_EXTENDED, _Carbon_RFC7231, _Carbon_RSS, _Carbon_W3C, _Carbon_resolveCarbon, _DateInterval_y, _DateInterval_m, _DateInterval_d, _DateInterval_h, _DateInterval_i, _DateInterval_s, _DateInterval_f, _DateInterval_days, _DateInterval_invert;
var DayOfTheWeek;
...
(function (MonthOfTheYear) {
    MonthOfTheYear[MonthOfTheYear["January"] = 0] = "January";
    MonthOfTheYear[MonthOfTheYear["February"] = 1] = "February";
    MonthOfTheYear[MonthOfTheYear["March"] = 2] = "March";
    MonthOfTheYear[MonthOfTheYear["April"] = 3] = "April";
    MonthOfTheYear[MonthOfTheYear["May"] = 4] = "May";
    MonthOfTheYear[MonthOfTheYear["June"] = 5] = "June";
    MonthOfTheYear[MonthOfTheYear["July"] = 6] = "July";
    MonthOfTheYear[MonthOfTheYear["August"] = 7] = "August";
    MonthOfTheYear[MonthOfTheYear["September"] = 8] = "September";
    MonthOfTheYear[MonthOfTheYear["October"] = 9] = "October";
    MonthOfTheYear[MonthOfTheYear["November"] = 10] = "November";
    MonthOfTheYear[MonthOfTheYear["December"] = 11] = "December";
...
(function (Constant) {
    ...
    Constant[Constant["DaysPerMonth"] = 30.436875] = "DaysPerMonth";
...
class Carbon {
    ...
    diff(date = null, absolute = false) {
        date = __classPrivateFieldGet(this, _Carbon_instances, "m", _Carbon_resolveCarbon).call(this, date);
        return new DateInterval(__classPrivateFieldGet(this, _Carbon_date, "f"), __classPrivateFieldGet(date, _Carbon_date, "f"), absolute);
    }
    /**
     ...
     * @return { number }
     */
    diffInMilliseconds(date = null, absolute = true) {
        const diff = this.diff(date);
        const diffInHours = (diff.m || diff.y ? diff.days : diff.d) * Constant.HoursPerDay;
        const value = Math.round((((diffInHours + diff.h) * Constant.MinutesPerHour + diff.i) * Constant.SecondsPerMinute + (diff.s)) * Constant.MillisecondsPerSecond);
    ...
    diffInSeconds(date = null, absolute = true) {
        ...
        if (diff.days === 0) {
            diff = _a.fixDiffInterval(diff, absolute);
        }
        let value = ((((diff.m || diff.y ? diff.days : diff.d) * Constant.HoursPerDay) + diff.h) * Constant.MinutesPerHour + diff.i) * Constant.SecondsPerMinute + diff.s;
        return absolute || !diff.invert ? value : -value;
    }
    /**
    ...
    diffInMonths(date = null, absolute = true) {
        const [yearStart, monthStart, dayStart] = this.format('Y-m-dHisv').split('-');
        const [yearEnd, monthEnd, dayEnd] = __classPrivateFieldGet(this, _Carbon_instances, "m", _Carbon_resolveCarbon).call(this, date).format('Y-m-dHisv').split('-');
        const diffInYears = parseInt(yearEnd) - parseInt(yearStart);
        const diffInMonths = parseInt(monthEnd) - parseInt(monthStart);
        let diff = diffInYears * Constant.MonthsPerYear + diffInMonths;
        if (diff > 0) {
            diff -= (parseInt(dayStart) > parseInt(dayEnd) ? 1 : 0);
        }
        else if (diff < 0) {
            diff += (parseInt(dayStart) < parseInt(dayEnd) ? 1 : 0);
        }
     ...
     * @return int
     */
    diffInQuarters(date = null, absolute = true) {
     ...
     */
    static fixDiffInterval(diff, absolute) {
...
class DateInterval {
     ...
     */
    get y() {
        return __classPrivateFieldGet(this, _DateInterval_y, "f");
    }
    /**
     ...
     */
    get m() {
        return __classPrivateFieldGet(this, _DateInterval_m, "f");
    }
    /**
     ...
     */
    get d() {
        return __classPrivateFieldGet(this, _DateInterval_d, "f");
    }
    /**
     ...
     */
    get h() {
        return __classPrivateFieldGet(this, _DateInterval_h, "f");
    }
    /**
     ...
     */
    get i() {
        return __classPrivateFieldGet(this, _DateInterval_i, "f");
    }
    /**
     ...
     */
    get s() {
        return __classPrivateFieldGet(this, _DateInterval_s, "f");
    }
    /**
     ...
     */
    get f() {
        return __classPrivateFieldGet(this, _DateInterval_f, "f");
    }
    /**
     ...
     */
    get days() {
        return __classPrivateFieldGet(this, _DateInterval_days, "f");
    }
    /**
     ...
     */
    get invert() {
        return __classPrivateFieldGet(this, _DateInterval_invert, "f");
    }
    /**
     ...
     */
    set y(value) {
        __classPrivateFieldSet(this, _DateInterval_y, value, "f");
    }
    /**
     ...
     */
    set m(value) {
        __classPrivateFieldSet(this, _DateInterval_m, value, "f");
    }
    /**
     ...
     */
    set d(value) {
        __classPrivateFieldSet(this, _DateInterval_d, value, "f");
    }
    /**
     ...
     */
    set h(value) {
        __classPrivateFieldSet(this, _DateInterval_h, value, "f");
    }
    /**
     ...
     */
    set i(value) {
        __classPrivateFieldSet(this, _DateInterval_i, value, "f");
    }
    /**
     ...
     */
    set s(value) {
        __classPrivateFieldSet(this, _DateInterval_s, value, "f");
    }
    /**
     ...
     */
    set f(value) {
        __classPrivateFieldSet(this, _DateInterval_f, value, "f");
    }
    /**
     ...
     */
    set invert(value) {
        __classPrivateFieldSet(this, _DateInterval_invert, value, "f");
    }
    /**
     ...
     */
    set days(value) {
        __classPrivateFieldSet(this, _DateInterval_days, value, "f");
    }
    /**
     ...
     * @param { boolean } absolute
     */
    constructor(base, target, absolute = false) {
        /**
         * Number of years.
         *
         * @type { number }
         */
        _DateInterval_y.set(this, 0);
        /**
         * Number of months.
         *
         * @type { number }
         */
        _DateInterval_m.set(this, 0);
        /**
         * Number of days.
         *
         * @type { number }
         */
        _DateInterval_d.set(this, 0);
        /**
         * Number of hours.
         *
         * @type { number }
         */
        _DateInterval_h.set(this, 0);
        /**
         * Number of minutes.
         *
         * @type { number }
         */
        _DateInterval_i.set(this, 0);
        /**
         * Number of seconds.
         *
         * @type { number }
         */
        _DateInterval_s.set(this, 0);
        /**
         * Number of milliseconds.
         *
         * @type { number }
         */
        _DateInterval_f.set(this, 0);
        /**
         * Total number of days the interval spans.
         *
         * @type { number }
         */
        _DateInterval_days.set(this, 0);
        /**
         * Is 1 if the interval is inverted and 0 otherwise
         *
         * @type { number }
         */
        _DateInterval_invert.set(this, 0);
        /**
         * Formatted interval.
         *
         * @type { string }
        ...
        const start = base < target ? base : target;
        const end = base > target ? base : target;
        const invert = base > target ? 1 : 0;
        const daysPerMonth = (month, year) => {
        ...
        let diffInMilliseconds = Math.abs(start.getTime() - end.getTime());
     ...
     */
    toString() {
        const years = this.y ? `%${this.y}y` : '';
        const months = this.m ? `%${this.m}m` : '';
        const days = this.d ? `%${this.d}d` : '';
        const format = `%R ${years} ${months} ${days} %H:%I:%S.%F`.replace(/ +(?= )/g, '');
        return this.format(format);
    }
}
_DateInterval_y = new WeakMap(), _DateInterval_m = new WeakMap(), _DateInterval_d = new WeakMap(), _DateInterval_h = new WeakMap(), _DateInterval_i = new WeakMap(), _DateInterval_s = new WeakMap(), _DateInterval_f = new WeakMap(), _DateInterval_days = new WeakMap(), _DateInterval_invert = new WeakMap();
