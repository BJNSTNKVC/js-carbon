...
var Constants;
(function (Constants) {
    Constants[Constants["YearsPerMillennium"] = 1000] = "YearsPerMillennium";
    Constants[Constants["YearsPerCentury"] = 100] = "YearsPerCentury";
    Constants[Constants["YearsPerDecade"] = 10] = "YearsPerDecade";
    Constants[Constants["MonthsPerYear"] = 12] = "MonthsPerYear";
    Constants[Constants["MonthsPerQuarter"] = 3] = "MonthsPerQuarter";
    Constants[Constants["QuartersPerYear"] = 4] = "QuartersPerYear";
    Constants[Constants["WeeksPerYear"] = 52] = "WeeksPerYear";
    Constants[Constants["WeeksPerMonth"] = 4] = "WeeksPerMonth";
    Constants[Constants["DaysPerYear"] = 365] = "DaysPerYear";
    Constants[Constants["DaysPerWeek"] = 7] = "DaysPerWeek";
    Constants[Constants["HoursPerDay"] = 24] = "HoursPerDay";
    Constants[Constants["MinutesPerHour"] = 60] = "MinutesPerHour";
    Constants[Constants["SecondsPerMinute"] = 60] = "SecondsPerMinute";
    Constants[Constants["SecondsPerHour"] = 3600] = "SecondsPerHour";
    Constants[Constants["MillisecondsPerSecond"] = 1000] = "MillisecondsPerSecond";
    Constants[Constants["MillisecondsPerDay"] = 86400000] = "MillisecondsPerDay";
    Constants[Constants["MicrosecondsPerMillisecond"] = 1000] = "MicrosecondsPerMillisecond";
    Constants[Constants["MicrosecondsPerSecond"] = 1000000] = "MicrosecondsPerSecond";
})(Constants || (Constants = {}));
class Carbon {
    /**
        ...
        for (const element of elements) {
            switch (element) {
                ...
                case 'z': {
                    ...
                    let day = Constants.MillisecondsPerDay;
                ...
                case 'W': {
                    ...
                    let weekNumber = Math.ceil((((parsedDate - yearStart) / Constants.MillisecondsPerDay) + 1) / Constants.DaysPerWeek);
                ...
                case 'Z': {
                    ...
                    const offsetInSeconds = hours * Constants.SecondsPerHour + minutes * Constants.SecondsPerMinute;
    ...
    isNextWeek() {
        const now = _a.now();
        const week = (now.week + 1).toString().padStart(2, '0');
    ...
    isNextDay() {
        ...
        const day = (now.day + 1).toString().padStart(2, '0');
    ...
    isNextHour() {
        ...
        const hour = (now.hour + 1).toString().padStart(2, '0');
    ...
    isNextMinute() {
        ...
        const minute = (now.minute + 1).toString().padStart(2, '0');
    ...
    isNextSecond() {
        ...
        const day = now.format('d');
        const hour = now.format('H');
        const minute = now.format('i');
        const second = (now.second + 1).toString().padStart(2, '0');
    ...
    isNextMillisecond() {
        ...
        const millisecond = (now.millisecond + 1).toString().padEnd(3, '0');
    ...
    toDate() {
        var _b;
        return new Date(new Date().toLocaleString('en-US', { timeZone: (_b = __classPrivateFieldGet(this, _Carbon_timezone, "f")) !== null && _b !== void 0 ? _b : undefined }));
    }
    /**
    ...
    get(value) {
        switch (value) {
            ...
            case 'quarter': {
                return Math.ceil(this.get('month') / Constants.MonthsPerQuarter);
            }
            case 'decade': {
                return Math.ceil(this.get('year') / Constants.YearsPerDecade);
            }
            case 'century': {
                let factor = 1;
            ...
            case 'local': {
                return parseInt(this.format('Z')) / Constants.SecondsPerMinute === __classPrivateFieldGet(this, _Carbon_date, "f").getTimezoneOffset() * -1;
            }
            case 'utc': {
