...
class Carbon {
    ...
    setDate(year, month, day) {
        ...
        return _a.parse(__classPrivateFieldGet(this, _Carbon_date, "f").toISOString());
    }
    /**
    ...
    setTime(hour, minute, second, millisecond) {
        __classPrivateFieldGet(this, _Carbon_date, "f").setHours(hour);
        __classPrivateFieldGet(this, _Carbon_date, "f").setMinutes(minute);
